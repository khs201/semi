...
const resetReg = document.querySelector("#resetReg");
const resetRegNo = document.querySelector("#resetRegNo");

resetReg.addEventListener("click", () => {


  // 입력 받은 회원 번호 얻어오기
  const inputNo = resetRegNo.value;

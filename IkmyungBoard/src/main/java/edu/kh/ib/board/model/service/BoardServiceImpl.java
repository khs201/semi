...
public class BoardServiceImpl implements BoardService {
	...
	public List<Board> selectPopularBoardList(int boardCode) {
		...
		return mapper.selectPopularBoardList(boardCode);
	}
	
	
	@Override
	public Map<String, Object> selectPopularBoardList(int boardCode, int cp) {
		...
		// 삭제되지 않은 게시글 수 조회
				 ...
				 * - 두 번째 매개 변수 -> RowBounds 객체 전달 변수
				 *  */
				List<edu.kh.ib.board.model.dto.Board> PopularBoardList = mapper.selectPopularBoardList(boardCode, rowBounds);

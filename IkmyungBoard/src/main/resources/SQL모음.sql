...
"MEMBER_NICKNAME" NVARCHAR2(10) NULL,
...
COMMENT ON COLUMN "MEMBER"."MEMBER_NO" IS '화원 번호(PK)';

COMMENT ON COLUMN "MEMBER"."MEMBER_EMAIL" IS '회원 이메일(ID)역활';
...
COMMENT ON COLUMN "UPLOAD_FILE"."FILE_RENAME" IS '파일 번경명';
...
COMMENT ON COLUMN "BOARD_LIKE"."MEMBER_NO" IS '화원 번호(PK)';
...
"COMMENT_WRITH_DATE" DATE DEFAULT SYSDATE NOT NULL,
